...
class LayoffImpactedCity(TestCase):
    ...
    def setUp(self):
        ...
        self.layoffs_data_empty = read_dataset(f'{data_dir}/layoffs.txt')
        self.layoffs_data_first_10 = read_dataset(f'{data_dir}/'
                                                  f'layoffs_first_10.txt')
        self.layoffs_data_last_5 = read_dataset(f'{data_dir}/'
                                                f'layoffs_last_5.txt')


    def test_layoff_impacted_city_empty(self):
        """Test using layoffs_empty.txt."""
        actual_result = self.layoffs_data_empty.impact_in_cities()
        expected_result = {}
        self.assertDictEqual(actual_result, expected_result)

    def test_layoff_impacted_city_first_10(self):
        """Test using layoffs_first_10.txt."""
        actual_result1 = self.layoffs_data_first_10.impact_in_cities()
    ...
    def test_layoff_impacted_city_last_5(self):
        ...
        actual_result2 = self.layoffs_data_last_5.impact_in_cities()
